...
def plot_mean_feature_importance(model: torch.nn.Module, dataset: torch.utils.data.Dataset, width=0.5):
    ...
    plt.barh(ind, x2_here, width, label='NAMs', align='center')
    # plt.yticks(ind + width / 2, cols_here, rotation=90, fontsize='large')
    plt.yticks(ind, cols_here)
    plt.xlabel('Mean Absolute Score', fontsize='x-large')
    plt.legend(loc='lower right', fontsize='large')
    plt.title('Feature Importance', fontsize='x-large')
    plt.show()
